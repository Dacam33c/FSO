...
/*
* Implementa o escalonador preemptivo-interrupt com múltiplas
* filas Round-Robin e prioridades estáticas. A prioridade 1 é a mais alta. 
* Usa sinais (SIGALRM para quantum, SIGCHLD para término) e pipe (para IPC). 
*/
